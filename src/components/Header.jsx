...
export default function Header(props){
    ...
    return(
        <div className="relative flex pl-2 pr-8 pb-5 pt-10">
            <i className="fa-solid fa-2x fa-book hover:scale-90 transition duration-300 cursor-pointer" onClick={()=>window.location.reload()}></i>  
             ...
             <i className="fa-regular fa-1.5x fa-moon  text-2xl hover:scale-90 transition duration-300 cursor-pointer relative md:left-10/12 left-8/12 mr-10"></i>   
