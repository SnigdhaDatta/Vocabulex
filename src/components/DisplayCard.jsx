...
export default function DisplayCard(props) {
  ...
  if (data?.title === "No Definitions Found") {
    return (
      <div className="bg-center">
        <br />
        <br />
        <p className="text-2xl text-fuchsia-600 pl-8 pr-8">
  ...
  if (!data) {
    return (
      <div className="flex flex-col justify-center items-center text-center text-6xl font-oleo hover:scale-90 transition duration-300 leading-snug min-h-[70vh]">
        <h4>
  ...
  return (
    <div className="pl-4 pr-4">
      ...
      <br />
      <div className="flex">
        <h1 className="text-5xl font-oleo">{data?.[0]?.word?.toLowerCase()}</h1>{" "}
        {/*word */}
        <button
          onClick={() => {
          ...
          return (
            <div key={partOfSpeech}>
              ...
              <div className="flex items-center gap-4 w-full">
                <h4 className="font-bold font-croissant text-2xl">
                  {partOfSpeech}
                </h4>
              ...
              {synonym.length !== 0 ? (
                <div className="flex pr-8">
                  ...
                  {synonym.map((ele, index) => {
                    return (
                      <p
                        key={index}
                        className="text-purple-600 font-extrabold font-gravitas pr-4"
                      >
                        {ele},
                      </p>
                    );
